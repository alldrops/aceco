			...
			<div class="content-block product-details">
				...
				<div class="product-wrapper">
					...
					<div class="rental-container">
						...
						<?php if( have_rows('prices') ): ?>
							...
							?>
								...
								<a href="#" class="options">
									...
									<span class="checkbox"></span> <?php echo $number_of_months; ?> months <span><?php echo $price ?></span>
            			...
            			<?php
            				...
            				while( have_rows('combo_prices') ): the_row();
            					...
            					<a href="#" class="options">
									...
									<span class="checkbox"></span> <?php echo $num_mon; ?> months <span><?php echo $price ?></span>
						...
						<a href="http://www.acecorentals.com.au/contact" class="btn-rent">Apply to Rent</a>
