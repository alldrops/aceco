		...
		<div class="content-section">
			<div class="content-block">
				<div class="content-wrapper">
					<h2>Having an appliance at home makes all the difference.</h2>
					<div class="text">
						<p>
						...
						<p>
							<strong>CALL <span>9817 0292</span> TO GET HIRING FAST!</strong>
						</p>
						</p> 
			...
			<div class="content-block dashed">
				<div class="content-wrapper">
					<h3>Local family based business.</h3>
					<div class="text">
						<p>
			...
			<div class="content-block">
				<div class="content-wrapper">
					<div class="text">
						...
						<p>
							<strong>
								CALL <span>ACECO RENTALS</span> TODAY TO HAVE YOUR WHITEGOODS DELIVERED AT A TIME THAT SUITS YOU ON <span>9817 0292</span>
							</strong>
						</p>
					</div>
