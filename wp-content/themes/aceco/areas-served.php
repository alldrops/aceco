		...
		<div class="content-section">
			...
			<div class="content-block dashed">
				<div class="content-wrapper">
					...
					<div class="text">
						...
						<p>
							<strong>
								HOW EASY CAN IT GET? CALL ACECO NOW TO COORDINATE YOUR DELIVERY ON <span>9817 0292</span>. 
							</strong>
						</p>
					</div>
				</div>
			...
			<div class="content-block">
				<div class="content-wrapper">
					<div class="text">
						<p>
							Not many companies are able to provide such service and maintain great value for money for their customers. We are proud to be able to offer excellent products and cost effective solutions to our Sydney customers.
						</p>
						<p>
							<strong>
								TO GET YOUR WHITE GOODS ORDERED AND DELIVERED ASAP - CONTACT US NOW ON <span>9817 0292</span>. 
							</strong>
						</p>
					</div>
				</div>
